...
<template>
  <div class="bg-white">
    <div>
      ...
      <main class="flex mx-auto max-w-8xl px-4 sm:px-6 lg:px-6">
        <section class="w-1/5">
        ...
        <div aria-labelledby="products-heading" class="pt-6 pb-24">
          ...
          <div class="grid grid-cols-1 gap-x-8 gap-y-10">
            ...
            <form class="hidden lg:block">
              ...
              <Disclosure as="div" v-for="section in filters" :key="section.id" class=" py-6" v-slot="{ open }">
      ...
      <section class="w-4/5">
        <div class="w-auto grid grid-rows-2 gap-y-2">

          <div class="relative h-32 w-32 grid h-screen place-items-center">
            <form class="absolute inset-x-0 top-0 h-16 top--10 w-full p-10 max-w-lg">
